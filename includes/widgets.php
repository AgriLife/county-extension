			...
			<ul class="books">
				<li>
					...
					<dl>
						...
						<dd class="book-cover"><img alt="rush and weeds book cover" class="book" src="http://brazos.agrilife.org/wp-content/themes/county/images/brush-weeds-cover.png" /></dd>
